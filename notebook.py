...
notepad = ScrolledText(root, width = 90, height = 40, background = "#333333", foreground = '#b7410e', font =45)
fileName = ' '
...
def cmdOpen():     #file menu Open option
    ...
    notepad.delete(0.0, END)
    SplitReadFile = t.split()
    for word in SplitReadFile:
        if word == "def":
            notepad.insert(END, ' ' + word,'function')
        else:
            notepad.insert(END, ' ' + word)
